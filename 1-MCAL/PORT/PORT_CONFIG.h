...
#define PORTC_PIN0_DIR      INIT_INPUT
#define PORTC_PIN1_DIR      INIT_INPUT
#define PORTC_PIN2_DIR      INIT_INPUT
#define PORTC_PIN3_DIR      INIT_INPUT
#define PORTC_PIN4_DIR      INIT_INPUT
#define PORTC_PIN5_DIR      INIT_INPUT
#define PORTC_PIN6_DIR      INIT_INPUT
#define PORTC_PIN7_DIR      INIT_INPUT
...
#define PORTA_PIN1_INITVAL      INIT_NORMAL_IN
#define PORTA_PIN2_INITVAL      INIT_NORMAL_IN
#define PORTA_PIN3_INITVAL      INIT_NORMAL_IN
#define PORTA_PIN4_INITVAL      INIT_NORMAL_IN
#define PORTA_PIN5_INITVAL      INIT_NORMAL_IN
#define PORTA_PIN6_INITVAL      INIT_NORMAL_IN
#define PORTA_PIN7_INITVAL      INIT_NORMAL_IN
								
#define PORTB_PIN0_INITVAL      INIT_NORMAL_IN
#define PORTB_PIN1_INITVAL      INIT_NORMAL_IN
#define PORTB_PIN2_INITVAL      INIT_NORMAL_IN
#define PORTB_PIN3_INITVAL      INIT_NORMAL_IN
#define PORTB_PIN4_INITVAL      INIT_NORMAL_IN
#define PORTB_PIN5_INITVAL      INIT_NORMAL_IN
