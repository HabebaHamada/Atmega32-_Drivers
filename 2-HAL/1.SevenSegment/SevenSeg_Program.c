...
{
	DIO_u8WritePortDirection(Copy_u8Port,DIO_u8PORT_OUTPUT);
	DIO_u8WritePinDirection(Copy_u8Enable_Pin,Copy_u8Enable_Port,DIO_u8PORT_OUTPUT);
}
...
void SSD_Display_Number(Seven_Segment_Object Copy_Seven_Segment, u8 Copy_u8Number)
{
	...
	*/
	...
	DIO_u8WritePinValue(Copy_Seven_Segment.Enable_Pin, Copy_Seven_Segment.Enable_port,READ_BIT(Copy_Seven_Segment.Mode, 0));
	DIO_u8WritePortValue(Copy_Seven_Segment.Port, (Copy_Seven_Segment.Mode) ^ (SSD_NUMBER_ARRAY[SSD_NUMBER_INDEX]));
}
